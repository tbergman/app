...
interface BankIDProps extends IconSize {
  fill?: string;
}

export const BankID: React.SFC<BankIDProps> = ({
  width,
  height,
  fill = colors.BLACK,
}) => (
  <Svg height={height} width={width} viewBox="-367 247.5 106.8 106.8">
    <Path
      fill={fill}
    ...
    <G>
      <Path fill={fill} d="M-289.4,329.8h6.5l-2.9,18.4h-6.5L-289.4,329.8z" />
      <Path
        fill={fill}
